...
# # train
# python train_simpletod.py \
# --model_save_name=model1_rand \
# --output_path="../../outputs/simpletod/" \
# --input="${root_path}todkg_dataset/processed/model1.lm.rand.input.train_retrieved.txt" \
# --dev_input="${root_path}todkg_dataset/processed/model1.lm.rand.input.dev_retrieved.txt" \
# --eos_token_id=50256 \
# --batch_size=16 \
# --max_epoch=50 \
# --learning_rate=1e-4 \
